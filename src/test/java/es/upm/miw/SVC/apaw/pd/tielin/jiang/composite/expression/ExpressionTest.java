...
import es.upm.miw.SVC.apaw.pd.tielin.jiang.composite.expression.Division;
import es.upm.miw.SVC.apaw.pd.tielin.jiang.composite.expression.Expresion;
import es.upm.miw.SVC.apaw.pd.tielin.jiang.composite.expression.Multiplicacion;
import es.upm.miw.SVC.apaw.pd.tielin.jiang.composite.expression.Numero;
import es.upm.miw.SVC.apaw.pd.tielin.jiang.composite.expression.Resta;
import es.upm.miw.SVC.apaw.pd.tielin.jiang.composite.expression.Suma;
...
public class ExpressionTest {
	...
	public void ini() {
		...
		this.exp6 = new Suma(
				new Resta(new Numero(3), new Multiplicacion(new Division(this.exp1, new Numero(2)), new Numero(3))),
				this.exp1); // ((3-((4/2)*3))+4)
	}
